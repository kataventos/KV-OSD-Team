...
static const uint8_t EEPROM_DEFAULT[EEPROM_SETTINGS] = {
	...
	0,   // S_VOLUME_ALT_MIN            30   //   "     "       "   (Altitude Min "    "    "   ___    "     "   "    0m
	...
	0,   // S_CS0,                    34    // 10 callsign char locations
	0,   // S_CS1,
	0,   // S_CS2,
	0,   // S_CS3,
	0,   // S_CS4,
...
static const uint8_t EEPROM_NTSC_DEFAULT[EEPROM_ITEM_LOCATION-EEPROM_SETTINGS] = {
	// ROW= Row position on screen (255= no action)
	// COL= Column position on screen (255= no action)
	// DSPL= Display item on screen
