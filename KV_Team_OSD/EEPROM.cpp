...
static const uint8_t EEPROM_DEFAULT[EEPROM_SETTINGS] = {
	...
	1,   // S_HEADING360                16
	0,   // S_UNITSYSTEM                17
	0,   // S_VIDEOSIGNALTYPE           18
	0,   // S_RESETSTATISTICS           19
	0,   // S_ENABLEADC                 20
	5,   // S_BLINKINGHZ                21   // 10=1Hz, 9=1.1Hz, 8=1,25Hz, 7=1.4Hz, 6=1.6Hz, 5=2Hz, 4=2,5Hz, 3=3,3Hz, 2=5Hz, 1=10Hz
	1,   // S_MWAMPERAGE                22
	40,  // S_CURRSENSSENSITIVITY       23   // May vary from 17 to 40mV/A (Sensor type)
	2,   // S_CURRSENSOFFSET_H          24   // offset(H/L) =0 for unidir sensors or =512 for bidirectional sensors, may be changed only of few units.
	0,   // S_CURRSENSOFFSET_L          25   // 2H+0L=512
	2,   // S_CLIMB_RATE_ALARM          26
	5,   // S_VOLUME_DIST_MAX           27   // Flying Volume Warning (Distance value in meters x100) by default is 500m
	25,  // S_VOLUME_ALT_MAX            28   //   "     "       "   (Altitude Max "    "    "   x2  )  "     "   "   50m
	0,   // S_VOLUME_ALT_MIN            29   //   "     "       "   (Altitude Min "    "    "   ___    "     "   "    0m
	105, // S_VIDVOLTAGEMIN             30
	30,  // S_PITCH_WARNING             31   // Warning message at given angle in degrees positive and negative (default 30°)
...
uint8_t EEPROM_NTSC_DEFAULT[EEPROM_ITEM_LOCATION-EEPROM_SETTINGS] = {
	...
	6,   // L_CURRENTTHROTTLEPOSITIONROW LINE14+22
	20,   // L_CURRENTTHROTTLEPOSITIONCOL
	1,    // L_CURRENTTHROTTLEPOSITIONDSPL
